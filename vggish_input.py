...
def waveform_to_examples(data, sample_rate, info = [], n_frames=0):
...
def wavfile_to_examples2(wav_file, base_path, n_frames=0, video_postfix='.mp4'):
    ...
    if n_frames == 0:
      ...
      video.release()
      num_frames = len(os.listdir(os.path.join(base_path, Constants.frame_folder_name,Constants.video_folder_name, vid)))
